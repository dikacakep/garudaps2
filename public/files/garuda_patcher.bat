...
TITLE GarudaPS Hosts Patcher
echo ======== GARUDAPS.COM HOSTS PATCHER ========
echo.
...
set "IP1=157.66.54.50"
set "IP2=157.66.54.50"

echo.
set /p DO_INSTALL=Do you want to install GarudaPS hosts entries? (Y/N): 
if /I "%DO_INSTALL%"=="Y" (
    call :remove_growtopia

    echo.
    if not defined IP1 (
        echo Failed to resolve garudaps.com - Visit us on discord.gg/garuda or garudaps.com!
        start https://discord.gg/Jj2KT2uZaa
