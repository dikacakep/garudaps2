...
const TUTORIAL_DATA: TutorialItem[] = [
   {
     ...
     steps: [
       ...
       { text: "Install the GarudaPs APK.", link: "https://www.mediafire.com/file/xhyzax3iuvftdg1/GarudaPS_x64_5.42.apk/file"},
    ...
    steps: [
      {
        ...
        link: "https://android.izzysoft.de/repo/apk/io.github.krlvm.powertunnel.android",
      },
      { text: "Open App → Menu (Plugin) → Hosts → Settings (Gear Icon)." },
      {
        text: "Enter this URL in the box:",
        code: "https://play.garudaps.com/android",
      },
    ...
    steps: [
      {
        ...
        link: "https://www.mediafire.com/file/ctly08te3i8rlwq",
      },
      {
  ...
  },
  {
    ...
    steps: [
      {
        text: "Download Virtual Host APK",
        link: "https://www.apkshub.com/app/com.github.xfalcon.vhosts",
        isDownload: false,
      },
      {
        text: "Download our Hosts File",
        link: "https://play.garudaps.com/garudaps",
        isDownload: true,
      },
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        code: "157.66.54.50 www.growtopia1.com\n157.66.54.50 www.growtopia2.com",
        isMultiLine: true,
      },
...
export default function TutorialSection() {
  ...
  const activeContent =
    TUTORIAL_DATA.find((t) => t.id === activeTab) || TUTORIAL_DATA[0];

  const hasVideo = !!activeContent.videoSrc;

  const handleVideoPlay = useCallback(() => {
    // Matikan BGM saat video play
    const event = new CustomEvent("garuda-bgm-control", {
      detail: { action: "pause" },
    });
    ...
    >
      ...
      <div className="container relative z-10 px-4 mx-auto">
        ...
        <div className="max-w-6xl mx-auto">
          {/* TAB BUTTONS */}
          <div className="flex overflow-x-auto overflow-y-hidden items-center pb-4 md:pb-0 md:justify-center gap-2 mb-8 p-2 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-sm relative z-20 scrollbar-hide">
            {TUTORIAL_DATA.map((tab) => (
              ...
              >
                ...
                {tab.videoSrc && (
                  <span
                    className={`ml-1 flex h-2 w-2 relative ${activeTab === tab.id ? "opacity-100" : "opacity-50"}`}
                  >
                    ...
                    <div className="flex flex-col items-center justify-center w-full sticky top-0">
                      ...
                      {hasVideo && (
                        <p className="mt-6 text-xs text-white/40 text-center max-w-50">
                          Tutorial video is available. Watch it on the right
                          side.
                        </p>
                      )}
                    </div>
